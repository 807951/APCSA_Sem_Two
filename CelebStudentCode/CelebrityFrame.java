...
{
    //Data members for the jf subclass instance 
    ...
    /**
     * Configures the jf window subclass to add the panel and set size based information.
     */
    private void setupFrame()
    {
        JFrame jf = new JFrame("jf Size Example");
