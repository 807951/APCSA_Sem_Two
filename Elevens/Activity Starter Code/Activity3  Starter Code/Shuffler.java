...
public class Shuffler {
    private static final int shuffleCount = 10;    //The number of shuffles to be implemented.
    private static final int valueCount = 10;      //The number of values to shuffle
